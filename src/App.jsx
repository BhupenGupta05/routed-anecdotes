...
const Anecdote = ({anecdote}) => (
  <div>
    ...
    for nore info see <a href={anecdote.info}>{anecdote.info}</a>
  </div>
)
...
const CreateNew = ({addNew, setNotification}) => {
  ...
  // while giving input using spread operator, reset was already in it, so the console was giving a warning. That's why, we filtered the reset function
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button onClick={() => { content.reset(); author.reset(); info.reset(); }} type='button'>reset</button>
      </form>
    </div>
  )
}
